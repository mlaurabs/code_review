...
def registrar_venda(id_cliente, id_produto, quantidade):
    ...
    # ERRO: verifica quantidade >= 0, mas deveria ser >= quantidade desejada
    if estoque[id_produto]["quantidade"] >= 0:
        # ERRO: não subtrai a quantidade corretamente do estoque
        estoque[id_produto]["quantidade"] = estoque[id_produto]["quantidade"]  # deveria subtrair

        # ERRO: escreve campos invertidos no registro
